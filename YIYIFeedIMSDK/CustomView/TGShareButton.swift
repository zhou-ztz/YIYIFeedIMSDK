...
class TGShareButton: UIButton {
    ...
    init(normalImage: UIImage, title: String) {
        ...
        self.setTitleColor(MainColor.normal.minor, for: .normal)
        self.titleLabel?.font = UIFont.systemFont(ofSize: RLFont.Button.toolbarTop.rawValue)
