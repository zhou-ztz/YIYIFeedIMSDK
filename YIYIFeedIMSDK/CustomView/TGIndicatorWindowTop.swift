//
//  TSGndicatorWindowTop.swift
//  YIYIFeedIMSDK
//
//  Created by yiyikeji_zhou on 2025/3/18.
//
...
class TGIndicatorWindowTop: UIView {
    ...
    func setUI() {
        ...
        case .success: // 成功，显示蓝色图标
            let stateImage = UIImage(named: "ic_rl_srs_success")!
        ...
        labelForTitle.textColor = RLColor.normal.content
    ...
    class func showDefaultTime(state: LoadingState, title: String?) {
        let indicator = TGIndicatorWindowTop(state: state, title: title)
        indicator.show(timeInterval: TGIndicatorWindowTop.defaultShowTimeInterval)
    }
    // MARK: - Private
