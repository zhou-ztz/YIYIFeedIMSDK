...
//  YIYIFeedIMSDK
//
//  Created by yiyikeji on 2025/4/9.
//
...
extension NotificationCenter {
     ...
     */
    @discardableResult
    func observe(_ name: NSNotification.Name?, object: AnyObject? = nil, action: @escaping () -> Void) -> Action {
    ...
    @discardableResult
    @nonobjc
    func observe(_ name: NSNotification.Name?, object: AnyObject? = nil, action: @escaping (NSNotification) -> Void) -> Action {
     ...
     */
    @discardableResult
    func add(observer: NSObject, name: NSNotification.Name?, object: AnyObject? = nil, action: @escaping () -> Void) -> Action {
        let action = NotificationCenterVoidAction(name: name, object: object, action: action)
        addObserver(action, selector: action.selector, name: name, object: object)
    ...
    @discardableResult
    @nonobjc
    func add(observer: NSObject, name: NSNotification.Name?, object: AnyObject? = nil, action: @escaping (NSNotification) -> Void) -> Action {
        let action = NotificationCenterParametizedAction(name: name, object: object, action: action)
        addObserver(action, selector: action.selector, name: name, object: object)
        retainAction(action, observer)
        return action
     ...
     */
    func stopObserving(action: Action) {
     ...
     */
    func stopObserver(_ observer: NSObject, name: NSNotification.Name? = nil, object: AnyObject? = nil) {
