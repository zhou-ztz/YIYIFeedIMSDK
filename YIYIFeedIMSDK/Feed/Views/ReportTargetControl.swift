...
class ReportTargetControl: UIControl {
    ...
    fileprivate let titleLabel: UILabel = UILabel(text: "", font: UIFont.systemFont(ofSize: 14), textColor: RLColor.normal.minor)
    // 暂先使用UILabel，之后更正为YYLabel
    fileprivate let detailLabel: UILabel = UILabel(text: "", font: UIFont.systemFont(ofSize: 12), textColor: RLColor.normal.minor)
