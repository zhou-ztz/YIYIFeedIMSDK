//
//  TGInputLocalContainerCell.swift
//  YIYIFeedIMSDK
//
...
class TGInputLocalContainerCell: UITableViewCell {
    ...
    static let cellIdentifier = "TGInputLocalContainerCell"
    ...
    func commonUI() {
        ...
        nameLab.snp.makeConstraints { make in
            make.top.equalTo(8)
            make.left.equalTo(self.localImg.snp.right).offset(10)
        }
