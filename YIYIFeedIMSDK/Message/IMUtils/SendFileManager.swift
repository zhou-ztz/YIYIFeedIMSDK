...
class SendFileManager: NSObject, UIDocumentPickerDelegate {
    public static let shared = SendFileManager()
    ...
    public static func fileIcon(with fileExtension: String) -> (icon: UIImage?, type: String) {
        var image = UIImage(named: "ic_unknown")
        ...
        switch item {
        case 0, 1, 2, 3:
            image = UIImage(named: "file_img")
            text = "Image"
        case 4, 5:
            image = UIImage(named: "file_xls")
            text = "Xlsx"
        case 6, 7:
            image = UIImage(named: "file_ppt")
            text = "Ppt"
        case 8, 9:
            image = UIImage(named: "file_html")
            text = "Html"
        case 10, 11:
            image = UIImage(named: "file_zip")
            text = "Zip"
        case 12:
            image = UIImage(named: "file_mp4")
            text = "Media"
        case 13:
            image = UIImage(named: "file_mp3")
            text = "Media"
        case 14, 15:
            image = UIImage(named: "file_doc")
            text = "Doc"
        case 16:
            image = UIImage(named: "file_pdf")
            text = "Pdf"
        case 17:
            image = UIImage(named: "file_txt")
            text = "Txt"
        case 18:
            image = UIImage(named: "file_rar")
            text = "Rar"
        default:
