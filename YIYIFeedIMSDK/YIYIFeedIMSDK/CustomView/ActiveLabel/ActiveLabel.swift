...
protocol ActiveLabelDelegate: class {
...
@IBDesignable class ActiveLabel: UILabel {
    ...
    @IBInspectable var highlightFontName: String? = nil {
        didSet { updateTextStorage(parseText: false) }
    }
    var highlightFontSize: CGFloat? = nil {
        didSet { updateTextStorage(parseText: false) }
    }
    ...
    func handleCustomTap(for type: ActiveType, handler: @escaping (String) -> ()) {
