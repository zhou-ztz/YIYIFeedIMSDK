...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/zhou-ztz/YIYIFeedIMSDK.git', :tag => '2.6.3'}
  ...
  spec.resources = ['YIYIFeedIMSDK/SDKResource.bundle', 'YIYIFeedIMSDK/TZImagePickerController/TZImagePickerController.bundle', 'YIYIFeedIMSDK/CustomView/Photo Editor/PhotoEditorViewController.xib', 'YIYIFeedIMSDK/Feed/Views/TGFeedDetailInteractiveView.xib', 'YIYIFeedIMSDK/Feed/Views/Report/ReportImageCollectionCell.xib', 'YIYIFeedIMSDK/Feed/TGReleasePulseViewController.xib', ''YIYIFeedIMSDK/CustomView/CustomTextfield.xib']
