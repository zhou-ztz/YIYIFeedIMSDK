...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/zhou-ztz/YIYIFeedIMSDK.git', :tag => '2.8.9'}
  ...
  spec.dependency 'SwiftSoup', '2.7.6'
